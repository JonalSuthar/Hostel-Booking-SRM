...
exports.getbooking = (req, res, next) => {
   ...
   if (req.session.mail != undefined) {
      return res.render('user/booking', { user: req.session.mail });
   }
   else {
      return res.render('user/booking', { user: "" });
   }
}
...
exports.getpayment = (req, res, next) => {
   ...
   if (req.session.mail != undefined) {
      return res.render('user/payment', { user: req.session.mail });
   }
   else {
      return res.render('user/payment', { user: "" });
   }
}
...
exports.gethostel = (req, res, next) => {
   ...
   if (req.session.mail != undefined) {
      return res.render('user/hostel', { user: req.session.mail });
   }
   else {
      return res.render('user/hostel', { user: "" });
   }
}
